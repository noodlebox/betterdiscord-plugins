...
(function () {
    ...
    function processServer(mutation) {
        ...
        // User profile popout
        mutationFind(mutation, ".userPopout-3XzG_A .headerTag-2pZJzA")
        ...
        mutationFind(mutation, ".headerInfo-30uryT .nameTag-m8r81H")
            .filter((_, e) => getUserId(e) === ownerId).not(".kawaii-tagged")
